...
function Login(event) {
    ...
    let player4username = document.getElementById("player4username").value;
    let player4password = document.getElementById("player4password").value;
    ...
    console.log("Player 4 username:", player4username);
    console.log("Player 4 password:", player4password);
    ...
    let player4Info = JSON.parse(localStorage.getItem(player4username));
    ...
    if (player1Info === null || player2Info === null || player3Info === null || player4Info === null) {
        alert("Pelo menos um dos jogadores não está registrado.");
               ...
               player4username === player4Info.username && player4password === player4Info.password) {
        ...
        let currentPlayer4 = new CurrentUserInfo(player4Info.username, player4Info.password);
        ...
        localStorage.setItem("currentPlayer4", JSON.stringify(currentPlayer4));

        alert("Login bem sucedido para todos os jogadores. O jogo vai começar quando clicarem ok...");
        window.location.href = "jogo4Players.html";
    } else {
